...
class CAllSaleExport
{
	...
	function ExportOrders2Xml($arFilter = Array(), $nTopCount = 0, $currency = "", $crmMode = false, $time_limit = 0, $version = false)
	{
		global $DB;
		$count = false;
	...
	function ExportContragents($arOrder = array(), $arProp = array(), $agent = array(), &$arResultStat, $bNewVersion = false)
	{
		?>
