...
?>
	...
	<tr>
		...
		<td>
			...
			<!--
			function getProductData(index, arParams, iblockID)
			{
			...
			<input name="filter_product_id" id="filter_product_id" value="<?= htmlspecialcharsbx($filter_product_id) ?>" size="5" type="text">&nbsp;<input type="button" value="..." id="cat_prod_button" onClick="window.open('sale_product_search.php?func_name=getProductData&caller=basket_admin', '', 'scrollbars=yes,resizable=yes,width=800,height=500,top='+Math.floor((screen.height - 800)/2-14)+',left='+Math.floor((screen.width - 600)/2-5));"><span id="product_name_alt" class="adm-filter-text-search"></span>
		</td>
	</tr>
	<tr>
