...
{
	if (array_key_exists('IBLOCK_ID', $arOldSetupVars) && $arOldSetupVars['IBLOCK_ID'] == $IBLOCK_ID)
	{
		if (array_key_exists('field_needed', $arOldSetupVars))
			$field_needed = $arOldSetupVars['field_needed'];
		if (array_key_exists('field_num', $arOldSetupVars))
			$field_num = $arOldSetupVars['field_num'];
		if (array_key_exists('field_code', $arOldSetupVars))
			$field_code = $arOldSetupVars['field_code'];
	}
	if (array_key_exists('fields_type', $arOldSetupVars))
		$fields_type = $arOldSetupVars['fields_type'];

	if (array_key_exists('delimiter_r', $arOldSetupVars))
		$delimiter_r = $arOldSetupVars['delimiter_r'];
	if (array_key_exists('delimiter_r_char', $arOldSetupVars))
		$delimiter_r_char = $arOldSetupVars['delimiter_r_char'];
	if (array_key_exists('delimiter_other_r', $arOldSetupVars))
	...
	if (array_key_exists('first_line_names', $arOldSetupVars))
		$first_line_names = $arOldSetupVars['first_line_names'];
	if (array_key_exists('export_files', $arOldSetupVars))
		$export_files = $arOldSetupVars['export_files'];
	if (array_key_exists('export_from_clouds', $arOldSetupVars))
