	...
	switch ($arParams['VIEW_MODE'])
	{
		...
		case 'LIST':
			...
			foreach ($arResult['SECTIONS'] as &$arSection)
			{
				...
				?><li <?if($arSection['ID']==$_SESSION['SECTION_ID_ACTIV']) echo "class='selected'"?> id="<?=$this->GetEditAreaId($arSection['ID']);?>"><a href="<? echo $arSection["SECTION_PAGE_URL"]; ?>"><? echo $arSection["NAME"];?><?
				if ($arParams["COUNT_ELEMENTS"])
				{
					?> <span>(<? echo $arSection["ELEMENT_CNT"]; ?>)</span><?
				}
