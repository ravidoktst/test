					...
					foreach ($arSource as $arProperties)
					{
						...
						elseif ($arProperties["TYPE"] == "TEXT")
						{
							?>
								...
								<input type="text" placeholder="<?=$arProperties["NAME"]?>" value="<?=$arProperties["VALUE"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" size="<?=$arProperties["SIZE1"]?>"
								<?if ($arProperties["REQUIED_FORMATED"]=="Y"):?>
									required
								<?endif;?>
								<?if ($arProperties["ID"]==2):?>
									input-mask="{ mask:'a{1,20}@a{1,10}.a{1,5}' ,greedy: false}"
								<?endif;?>	
						...
						elseif ($arProperties["TYPE"] == "TEXTAREA")
						{
							...
							?>
								...
								<textarea placeholder="<?=$arProperties["NAME"]?>" rows="<?=$rows?>" cols="<?=$arProperties["SIZE1"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>"
								<?if ($arProperties["REQUIED_FORMATED"]=="Y"):?>
								required
								<?endif;?>
