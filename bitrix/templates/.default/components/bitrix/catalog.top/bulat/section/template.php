...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	//new dBug($arItem);
?>
	<li id="<? echo $strMainID; ?>"><a id="<? echo $arItemIDs['PICT']; ?>"
			href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"
			title="<? echo $strTitle; ?>">
			<div class="image"><img src="<?echo $arItem["PREVIEW_PICTURE"]["SRC"] ? $arItem["PREVIEW_PICTURE"]["SRC"] : '/img/nophoto220.jpg';?>" alt=""></div>
			<h3 class="name"><?=$arItem['NAME']?></h3>
			<div class="price"><?=$arItem['PRICES']['BASE']['PRINT_VALUE_NOVAT']?></div>
			<a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="button blue" href="javascript:void(0)" rel="nofollow"><?
